...
<body>
   <form method="post" action="script.php">
       <textarea placeholder="Введите список запросов" style="width:400px;height:500px;white-space:pre-line;" , name="phrases"></textarea><br>
      ...
      <input type="text" name="token" id="token"><label for="token">Введите токен</label><br>
